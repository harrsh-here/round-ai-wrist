...
const WeatherScreen = ({ onNavigate }: WeatherScreenProps) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-start h-full overflow-y-auto overflow-x-hidden watch-scroll">
      {/* Fixed Header */}
      ...
      {/* Scrollable Content */}
      <div className="watch-content-safe flex flex-col items-center w-full pt-24 pb-4 px-4 overflow-y-auto" 
        style={{ 
          overflowY: 'scroll', 
        ...
        {/* Current Weather */}
        <div className="glass-bg p-4 rounded-2xl text-center mb-4 w-full max-w-[200px] watch-glow animate-fade-in">
        ...
        {/* Hourly Forecast */}
        <div className="w-full max-w-[220px] mb-4 pb-2">
          ...
          <div className="flex justify-between space-x-1">
            {forecast.map((item, index) => {
              ...
              return (
                <div
                  key={item.time}
                  className="glass-bg p-2 rounded-lg text-center flex-1 watch-glow animate-fade-in"
                  style={{ 
